...
namespace SpaceWireUnitTests
{
    ...
    public class RmapTests
    {
        ...
        public void TestCRC()
        {
            ...
            Assert.AreEqual(0, crcTest.Check("fe 01 4d 20 00 00 03 02 fe 00 00 00 00 00 01 00 00 00 04 dc"));
        }
        ...
        public void testMeadhbhsParser()
        {
            ...
            string[] array = new string[1];
            array[0] = "C:/Users/wjh/Documents/STAR-Dundee-Industrial-Project/Star-Dundee-WPF/Star-Dundee-WPF/DataFiles/test6/link8.rec";
